...
*/
   public int numberOfIcosahedrons() {
      if (icosahedronList.length == 0) {
         ...
         int numOfIcos = icosahedronList.length;
         return numOfIcos;
      }
   }
   ...
   */
   public double averageSurfaceArea() {
      ...
      if (icosahedronList.length > 0) {
         averageSurfaceArea = totalSurfaceArea() / icosahedronList.length;
   ...
   */
   public double averageVolume() {
      ...
      if (icosahedronList.length > 0) {
         averageVolume = totalVolume() / icosahedronList.length;
   ...
   */
   public String toString() {
      ...
      while (index < icosahedronList.length) {
