...
*/
   ...
   */
   ...
   /**This method finds the icosahedron in the array with the shortest edge.
   @return shortest - icosahedron with the shortest edge
   */
   public Icosahedron findIcosahedronWithShortestEdge() {
      if (numberOfIcos <= 0) { //if no Icosahedrons in list return null
         return null;
      }
      //Find shortest edge
      int index = 0;
      Icosahedron sIcos = icosahedronList[0];
      double eSmallest = icosahedronList[0].getEdge();
      while (index < numberOfIcos) {
         if (!(eSmallest < icosahedronList[index].getEdge())) {
            eSmallest = icosahedronList[index].getEdge();
            sIcos = icosahedronList[index];
         }
         index++;
      }
      return sIcos;
   ...
   /**This method finds the icosahedron in the array with the longest edge.
   @return longest - icosahedron with the longest edge.
   */
   public Icosahedron findIcosahedronWithLongestEdge() {
      ...
      //Find longest edge
      int index = 0;
      Icosahedron lIcos = icosahedronList[0];
      double eLargest = icosahedronList[0].getEdge();
      while (index < numberOfIcos) {
         if (eLargest < icosahedronList[index].getEdge()) {
            eLargest = icosahedronList[index].getEdge();
            lIcos = icosahedronList[index];
         }
         index++;
      }
      return lIcos;
   ...
   /**This method finds the icosahedron in the array with
   the smallest volume.
   @return smallest - icosahedron with the smallest volume
   */
   public Icosahedron findIcosahedronWithSmallestVolume() {
      ...
      int index = 0;
      Icosahedron sIcos = icosahedronList[0];
      double vSmallest = icosahedronList[0].volume();
      while (index < numberOfIcos) {
         if (!(vSmallest < icosahedronList[index].volume())) {
            vSmallest = icosahedronList[index].volume();
            sIcos = icosahedronList[index];
         }
         index++;
      }
 ...
 /**This method finds the icosahedron in the array with
   the largest volume.
   @return lIcos - icosahedron with the smallest volume
   */
   public Icosahedron findIcosahedronWithLargestVolume() {
      ...
      int index = 0;
      Icosahedron lIcos = icosahedronList[0];
      double vLargest = icosahedronList[0].volume();
      while (index < numberOfIcos) {
         if (vLargest < icosahedronList[index].volume()) {
            vLargest = icosahedronList[index].volume();
            lIcos = icosahedronList[index];
         }
         index++;
      }
