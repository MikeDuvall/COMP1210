...
*/
   ...
   */
   ...
   @param label, color, edge - the label, color, and edge of icos being added
   */
   ...
   */
   public Icosahedron findIcosahedron(String label) {
      ...
      for (Icosahedron i : icosahedronList) {
         if (i.getLabel().toLowerCase().equals(label.toLowerCase())) {
   ...
   */
   ...
   @param label, color, edge - that of the desired icos
