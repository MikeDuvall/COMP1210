...
//import java.io.InvalidCategoryException;
import java.io.File;
...
*/
   ...
   public void readCardholderFile(String fileIn) 
      ...
      while (scanFile.hasNext()) {
         ...
         try {
            ...
            String errorLine = line + " *** invalid category ***";
            this.addInvalidRecord(errorLine);
         }
         catch (NumberFormatException e) {
            String errorLine = line + " *** invalid numeric value ***";
            this.addInvalidRecord(errorLine);
         }
   ...
   */
   ...
   //Part 3 addition
   /**This method returns all the invalid records.
   @return output - the invalid records
   */
   public String generateInvalidRecordsReport() {
      String output = "-----------------------\n"
         + "Invalid Records Report"
         + "\n-----------------------\n";
      for (String e: invalidRecords) {
         output += e.toString() + "\n\n";
      }
      return output;
   }
