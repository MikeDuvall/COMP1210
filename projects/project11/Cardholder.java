...
public abstract class Cardholder implements Comparable<Cardholder> {
   ...
   */
   ...
   // Methods for Project 10
   /**This method is required to because this class implements
   Comparable.
   @param other - the object being compared to
   @return - negative if ahead alphabetically, negative if behind, 0 if same
   */
   public int compareTo(Cardholder other) {
      return (int) this.getName().compareToIgnoreCase(other.getName());
   }
}